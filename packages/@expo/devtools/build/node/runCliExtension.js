...
exports.testing_getExpoCliPluginParameters = void 0;
exports.runCliExtension = runCliExtension;
...
exports.testing_getExpoCliPluginParameters = getExpoCliPluginParameters;
// --------------- LOGGING HELPERS  ---------------
/**
 * We're wrapping console methods to output structured JSON messages.
 */
const asJson = (level, message, args) => JSON.stringify([{ type: 'text', text: (0, util_1.format)(message, ...args), level }]);
