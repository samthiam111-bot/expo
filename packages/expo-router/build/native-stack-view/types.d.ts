import type { ParamListBase, RouteProp, ScreenListeners, StackNavigationState } from '@react-navigation/native';
import type { PropsWithChildren } from 'react';
import type { ColorValue, StyleProp, TextStyle, ViewStyle } from 'react-native';
import type { BlurEffectTypes, GestureResponseDistanceType, ScrollEdgeEffect, ScreenOrientationTypes, StackAnimationTypes, StackPresentationTypes, SwipeDirectionTypes } from 'react-native-screens';
/**
...
export interface NativeStackOptions {
    ...
    headerLargeTitleStyle?: StyleProp<Pick<TextStyle, 'fontFamily' | 'fontSize' | 'fontWeight' | 'color'>>;
    /**
...
export interface NativeStackProps extends PropsWithChildren {
     ...
     */
    screenOptions?: NativeStackOptions | ((props: {
     ...
     */
    screenListeners?: ScreenListeners<StackNavigationState<ParamListBase>, NativeStackNavigationEventMap> | ((prop: {
        route: RouteProp<ParamListBase, string>;
        navigation: any;
