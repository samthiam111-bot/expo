...
<ContentSpotlight
  alt="Updates JavaScript API example"
...
| ------------------------------------------------------------------------------------------ | -------------- |
| Fix a bug or crash in JavaScript code and deploy updates in minutes                        | <YesIcon />    |
| Update copy, translations, UI styling, or screen layouts                                   | <YesIcon />    |
| Roll out changes to a percentage of users using [rollouts](/eas-update/rollouts/)          | <YesIcon />    |
| Publish updates from [CI or automated workflows](/eas/workflows/pre-packaged-jobs/#update) | <YesIcon />    |
| Test updates with internal teams before production release                                 | <YesIcon />    |
| Change to native code or native dependencies                                               | <NoIcon />     |
| Change to app permissions (camera, location, and others)                                   | <NoIcon />     |
| Update the Expo SDK version                                                                | <NoIcon />     |
| Anything that requires a new app binary version                                            | <NoIcon />     |
...
<Collapsible summary="Can I use EAS Update inside EAS Workflows or from other CI/CD pipelines?">
